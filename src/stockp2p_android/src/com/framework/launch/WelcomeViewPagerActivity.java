...
import com.pactera.nci.framework.Frameworkdate;
import com.pactera.nci.framework.Manager;
import com.push.baidu.Utils;
...
public class WelcomeViewPagerActivity extends FragmentActivity {
	...
	private void init() {
		...
		// (oldVersionName.equals(versionName)) && (!"setting".equals(source))
		if ((oldVersionName.equals(versionName)) && (!"setting".equals(source))) {
			...
			// // Bitmap bm = CommonUtil.getBitMap(
			// // WelcomeViewPagerActivity.this, imageResId[i]);
			// // BitmapDrawable bd = new BitmapDrawable(
			// // WelcomeViewPagerActivity.this.getResources(), bm);
			...
			// for (int i = 0; i < imageResId_middle.length; i++) {
			// if (i == 0) {
			// dots.add(findViewById(R.id.v_dot));
			// } else {
			...
			// LinearLayout ll_id = (LinearLayout) findViewById(R.id.ll_id);
			// ll_id.setOnClickListener(new View.OnClickListener() {
			// @Override
			// public void onClick(View v) {
	...
	private void startBaiduPush() {
		// 开启百度推送服务
		// SharedPreferences
		// sharedPreferences=this.getSharedPreferences("BaiduPush",
		// this.MODE_PRIVATE);
		// Editor editor = sharedPreferences.edit();
		// String
		// isBaiduPushRegistSuccess=sharedPreferences.getString("isBaiduPushRegistSuccess",
		// "");
		// System.out.println("isBaiduPushRegistSuccess:"+isBaiduPushRegistSuccess);
		// if(!isBaiduPushRegistSuccess.equals("true"))
		// {
	...
	private void initHost() {
		if (Constants.STATUS.equals("1")) {
			...
			// Constants.PROTOCOL = "https://";// https
			Constants.PROTOCOL = "http://";// http
			Constants.HOST = "10.1.91.148";// 内网环境
			Constants.PORT = 9081;// http测试
			// Constants.HOST = "10.8.51.4";// 老莫机器环境
			// Constants.PORT = 8080;// 老莫机器端口
			// Constants.HOST = "10.1.91.148";// 内网环境
			// Constants.PORT = 9081;// http测试
			// Constants.HOST = "10.8.51.4";// 老莫机器环境
			// Constants.HOST = "10.8.51.20";// xiaofeng机器环境
			// Constants.PORT = 9080;// http开发
			// Constants.PORT = 9443;// https开发
			// Constants.PORT = 9044;//https测试
			// Constants.HOST = "10.8.57.25";// 汉卿ip
			// Constants.PORT = 8999;// 汉卿端口
