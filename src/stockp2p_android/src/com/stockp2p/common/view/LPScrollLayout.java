...
public class LPScrollLayout extends ViewGroup {
	...
	public LPScrollLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public LPScrollLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (xDiff > mTouchSlop && Math.abs(deltaX) > Math.abs(deltaY)) {
