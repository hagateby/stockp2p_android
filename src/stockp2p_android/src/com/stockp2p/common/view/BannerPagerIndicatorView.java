 ...
 *
 */
public class BannerPagerIndicatorView extends LinearLayout
{
	/**
	 * 绘制三角形的画笔
	 */
	...
	public BannerPagerIndicatorView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.BannerPagerIndicatorView);
		mTabVisibleCount = a.getInt(R.styleable.BannerPagerIndicatorView_item_count,
				COUNT_DEFAULT_TAB);
